          ...
          <div className="p-6">
            <div className="flex mb-4">
              <input
                ...
                className="flex-grow mr-2 pr-2 pl-2 bg-teal-50 border-teal-200 focus:ring-2 focus:ring-teal-300 focu:border-transparent"
              />
              <Button
            ...
            <AnimatePresence>
              {todos.map((todo: Todo) => (
                ...
                >
                  ...
                  {/* 削除アイコン */}
                  <Trash2 className='w-5 h-5 text-teal-500 ml-2 cursor-pointer' onClick={() => handleDeleteTodo(todo.id)} />
